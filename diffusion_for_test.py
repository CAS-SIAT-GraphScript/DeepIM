...
with open(args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new', 'rb') as f:
    print('66 ' + args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new',)
    graph = pickle.load(f)
...
with open(args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new', 'rb') as f:
    print('194 ' + args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new')
    graph = pickle.load(f)
...
with open(args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new', 'rb') as f:
    print('238 ' + args.dataset + '_mean_' + args.diffusion_model + str(10 * args.seed_rate) + '.SG.new')
    graph = pickle.load(f)
